...
exports.findFunctionParameterTypes = findFunctionParameterTypes;
...
function matchFunctionParameterTypeAnnotation(testFilePath, functionName, expectedParameterTypeArray) {
    it(`${functionName} should have parameters with explicit type annotations of: ${expectedParameterTypeArray}`, () => {
        ...
        const paramTypes = [];
        findFunctionParameterTypes(sourceFile, functionName, paramTypes, expectedParameterTypeArray);
...
function findFunctionParameterTypes(node, functionName, accumulator, expectedParameterTypeArray) {
    var _a;
    ...
    ts.forEachChild(node, (childNode) => findFunctionParameterTypes(childNode, functionName, accumulator, expectedParameterTypeArray));
}
