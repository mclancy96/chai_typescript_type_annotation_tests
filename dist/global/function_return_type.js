...
exports.findFunctionReturnType = findFunctionReturnType;
...
function findFunctionReturnType(node, functionName) {
    ...
    return (ts.forEachChild(node, (childNode) => findFunctionReturnType(childNode, functionName)) || "");
}
